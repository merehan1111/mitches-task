  ...
  return (
    <div className="relative w-full max-w-[1512px] mx-auto p-4 md:p-6">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
             flex justify-between items-center z-10 w-full max-w-[1456px] hidden sm:flex">
     ...
     style={{ touchAction: "pan-x", WebkitOverflowScrolling: "touch" }}>
        ...
        {teamData.map((member, index) => (
          ...
          ref={(el) => { itemsRef.current[index] = el; }}
               className="relative flex-shrink-0 w-[280px] sm:w-[320px] md:w-[500px] h-[380px] md:h-[500px] 
                          bg-[#F6F6F6] border-t border-gray-300 rounded-lg shadow-lg overflow-hidden snap-center">
            {/* Image */}
            <img src={member.image} alt={member.name} className="absolute inset-0 w-full h-full object-cover rounded-lg" />
            ...
            <div className="absolute bg-white text-black border-t border-gray-300 rounded-md w-[90%] h-auto top-[65%] left-[5%] p-3 md:p-6">
              ...
              <div className="absolute top-8 right-6 sm:hidden">
                <button className="bg-black p-[8px] rounded-full shadow-md hover:scale-110 transition-all flex 
